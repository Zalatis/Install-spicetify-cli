...
echo 1 - Désactiver les pubs
echo 1 - Réactiver les pubs
echo.
SET /p reponse4="Votre choix : "
If /i "%reponse4%"=="1" GOTO DisableAds
If /i "%reponse4%"=="2" GOTO RestoreAds
ECHO "%reponse4%" n'est pas un numéro valide !
...
echo *************************************************
echo *                                               *
echo *      Les pubs Spotify ont été bloquées        *
echo *                                               *
echo *************************************************
echo.
